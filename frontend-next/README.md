...
- **Agent Kernel & Prompt Files**: The core agent system instructions and persona prompts are located in `/Fabrica_kernel/prompts/` (`01_identity.md` to `07_app_guide.md`).
