...
This directory contains the Next.js 15 static client frontend for **Fabrica — The Autonomous Business Partner**.
...
- **3-Panel Dashboard (`app/dashboard/page.tsx`)**:
  ...
  - **Panel C**: 50/50 Split view for **Your Data** (`raw_data`) and **Your Systems** (`system_components`) divided by a crisp 1.5px vertical separator line.
