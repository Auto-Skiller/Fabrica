...
const PERSONAS_MAP = {
  EN: [
    {
      id: 'enterprise',
      tab: "I'm scaling an enterprise",
      pain: 'Your legacy data has no unified system-of-record for AI-driven change.',
      fix: 'Raw inputs land in a relational, RLS-isolated database and get mapped to real architecture requirements — not another slide deck.',
      proof: 'Dependency Graph — Inbox → Gateway → OS Prompts/Data',
    },
    {
      id: 'erp',
      tab: 'I run ERP / automations',
      pain: 'Consultants deliver PDFs and Figma files. You need something that actually runs.',
      fix: 'We ship configured Odoo modules and live n8n workflows with real telemetry — JSON-RPC success rate, trigger counts, error ratios.',
      proof: 'Live Telemetry — sync frequency, webhook success rate',
    },
    {
      id: 'marketing',
      tab: 'I run marketing & media',
      pain: "Your campaign tool doesn't talk to your content tool, which doesn't talk to your reporting.",
      fix: 'One Standard mission coordinates copy generation, campaign setup, and CPC/reach telemetry inside the same backlog.',
      proof: 'CPC / Reach / Engagement — one backlog, one source of truth',
    },
    {
      id: 'builder',
      tab: "I'm building a product",
      pain: 'Every new chat session forgets yesterday’s decisions. You re-explain everything, every time.',
      fix: 'Missions persist through Drafting → Planning → Execution → Archive. Any agent can resume exactly where the last one stopped.',
      proof: 'Mission Board — 4 statuses × 5 mission types',
    },
  ],
  FR: [
    {
      id: 'enterprise',
      tab: "Je développe une entreprise",
      pain: "Vos données héritées n'ont pas de système de référence unifié pour les évolutions IA.",
      fix: 'Les entrées brutes arrivent dans une base de données relationnelle isolée par RLS et sont mappées à de vraies exigences d’architecture.',
      proof: 'Graphe de Dépendance — Boîte d’Entrée → Passerelle → Prompts/Données OS',
    },
    {
      id: 'erp',
      tab: "J'exécute ERP & automatisations",
      pain: 'Les consultants fournissent des PDF et Figma. Vous avez besoin de quelque chose qui s’exécute réellement.',
      fix: 'Nous livrons des modules Odoo configurés et des flux n8n en direct avec une télémétrie réelle.',
      proof: 'Télémétrie en Direct — fréquence de synchro, taux de réussite webhook',
    },
    {
      id: 'marketing',
      tab: 'Je gère le marketing & médias',
      pain: "Vos outils de campagne, de contenu et de suivi ne communiquent pas entre eux.",
      fix: 'Une mission standard coordonne la génération de texte, la configuration de campagne et la télémétrie CPC dans le même backlog.',
      proof: 'CPC / Portée / Engagement — un seul backlog, une seule source de vérité',
    },
    {
      id: 'builder',
      tab: 'Je construis un produit',
      pain: 'Chaque session de chat oublie les décisions d’hier. Vous devez tout réexpliquer à chaque fois.',
      fix: 'Les missions persistent à travers Brouillon → Planification → Exécution → Archive. Tout agent reprend là où le précédent s’est arrêté.',
      proof: 'Tableau des Missions — 4 statuts × 5 types de missions',
    },
  ],
  AR: [
    {
      id: 'enterprise',
      tab: 'أدير مؤسسة متنامية',
      pain: 'بياناتك القديمة تفتقر إلى نظام سجل موحد لإدارة التغييرات بالذكاء الاصطناعي.',
      fix: 'تصل مدخلاتك إلى قاعدة بيانات علاقية معزولة بـ RLS ويتم تحويلها إلى متطلبات بنية تحتية حقيقية.',
      proof: 'مخطط التبعيات — الواردات ← البوابة ← الأوامر والبيانات التشغيلية',
    },
    {
      id: 'erp',
      tab: 'أدير أنظمة ERP والأتمتة',
      pain: 'يقدم المستشارون ملفات PDF وتصميمات Figma بينما تحتاج إلى نظام يعمل بالفعل.',
      fix: 'نقوم بنشر وحدات Odoo مهيأة وتدفقات n8n حية مع قياسات أداء دقيقة وفعالة.',
      proof: 'القياس المباشر — تردد التزامن، معدل نجاح الويب هوك',
    },
    {
      id: 'marketing',
      tab: 'أدير التسويق والإعلام',
      pain: 'أدوات الحملات لا تتصل بأدوات المحتوى أو التقارير.',
      fix: 'مهمة واحدة تنظم إنتاج النصوص، وإعداد الحملات، وقياسات تكلفة النقرة والوصول في قائمة واحدة.',
      proof: 'تكلفة النقرة / الوصول / التفاعل — قائمة مهام واحدة ومصدر موحد',
    },
    {
      id: 'builder',
      tab: 'أبني منتجًا جديدًا',
      pain: 'تنسى جلسات المحادثة الجديدة قرارات الأمس، مما يضطرك لإعادة الشرح باستمرار.',
      fix: 'تستمر المهام عبر التخطيط والتنفيذ والأرشيف. يمكن لأي مساعد استئناف العمل بدقة.',
      proof: 'لوحة المهام — 4 حالات × 5 أنواع من المهام',
    },
  ]
};
...
const PAIN_PROMISE_MAP = {
  EN: [
    { pain: 'Transient memory — forgets your business context the moment the tab closes.', fix: 'Zero context drift: Supabase RLS relational engine, nothing critical lives in a scratchpad.' },
    { pain: 'One AI guess, delivered with total confidence, whether or not it’s right.', fix: 'Brainstorming Mode surfaces 3 distinct options with a "Why" — you choose the tradeoff.' },
    { pain: 'Generic text answers with no connection to your real systems.', fix: 'Compiled, functional outputs: Odoo ERP extensions, n8n workflows, real code modules.' },
    { pain: 'Runs generated code unsupervised — a breach waiting to happen.', fix: 'Node.js `vm` sandbox: locked globals, 1000ms CPU budget, RLS + CMEK isolation.' },
    { pain: 'Locked into one model vendor’s roadmap and pricing.', fix: 'Model Selector: swap Gemini, Claude, or any OpenRouter model mid-session.' },
    { pain: 'An agent that loops forever on a broken task, burning tokens quietly.', fix: 'Three failed approaches halts execution on purpose and logs a blocker for you.' },
  ],
  FR: [
    { pain: 'Mémoire éphémère — oublie votre contexte d’entreprise dès la fermeture de l’onglet.', fix: 'Aucune perte de contexte : moteur relationnel Supabase RLS, rien d’essentiel sur bloc-notes.' },
    { pain: 'Une seule prédiction IA livrée avec confiance, qu’elle soit exacte ou non.', fix: 'Le Mode Brainstorming propose 3 options distinctes avec un "Pourquoi" — vous choisissez.' },
    { pain: 'Réponses textuelles génériques sans lien avec vos systèmes réels.', fix: 'Résultats compilés et fonctionnels : extensions ERP Odoo, flux n8n, vrais modules de code.' },
    { pain: 'Exécute du code généré sans surveillance — une faille de sécurité garantie.', fix: 'Sandbox `vm` Node.js : variables bloquées, budget CPU 1000ms, isolation RLS + CMEK.' },
    { pain: 'Bloqué par la feuille de route et la tarification d’un seul fournisseur d’IA.', fix: 'Sélecteur de Modèles : passez de Gemini à Claude ou tout modèle OpenRouter à tout moment.' },
    { pain: 'Un agent qui boucle indéfiniment sur une tâche cassée en brûlant des jetons.', fix: 'Trois tentatives échouées arrêtent l’exécution et enregistrent un blocage clair.' },
  ],
  AR: [
    { pain: 'ذاكرة مؤقتة — تنسى سياق عملك فور إغلاق علامة التبويب.', fix: 'لا يوجد فقدان للسياق: محرك علاقي يعتمد RLS، ولا شيء مهم يعتمد على مفكرة مؤقتة.' },
    { pain: 'تخمين ذكاء اصطناعي واحد يُقدم بثقة مطلقة بغض النظر عن صحته.', fix: 'وضع العصف الذهني يعرض 3 خيارات متميزة مع توضيح السبب لتقرر بنفسك.' },
    { pain: 'إجابات نصية عامة غير مرتبطة بأنظمتك الحقيقية.', fix: 'مخرجات برمجية جاهزة: امتدادات Odoo ERP، مسارات n8n، وحزم برمجية حقيقية.' },
    { pain: 'تشغيل كود برمجي دون رقابة — مما يشكل مخاطرة أمنية.', fix: 'بيئة معزولة `vm` لـ Node.js: صلاحيات مقيدة، حد معالجة 1000ms، وعزل تام.' },
    { pain: 'التقيد بخريطة طريق وأسعار مزود ذكاء اصطناعي واحد.', fix: 'محدد النماذج: التبديل بين Gemini أو Claude أو أية نماذج OpenRouter بسهولة.' },
    { pain: 'مساعد يدور في حلقة مفرغة عند حدوث خطأ مستهلكًا الموارد.', fix: 'ثلاث محاولات فاشلة توقف التنفيذ تلقائيًا وتسجل العائق للمراجعة.' },
  ]
};
...
const LANDING_TEXT = {
  EN: {
    nav: { matrix: 'The Matrix', systems: 'Systems', workspace: 'Workspace', deepResearch: 'Deep Research', faqs: 'FAQs', openDashboard: 'Open Dashboard' },
    hero: {
      tag: 'Digital Transformation for Enterprises & Power Users',
      h1: 'WE BUILD CUSTOM OUTPUTS/SYSTEMS FROM ANY INPUT.',
      sub: 'AI knows HOW to build. Fabrica shows it WHAT.',
      desc: 'Your AI model is the brain. It’s smart, and it’s disposable — swap Gemini for Claude for any OpenRouter model without losing a thing. Fabrica is the body: the relational database, the sandboxed execution channel, and the mission history that remembers what the brain forgot.',
      launchBtn: 'Launch Your Workspace',
      seeBuildsBtn: 'See What It Actually Builds'
    },
    sections: {
      personasTitle: 'CHOOSE YOUR ARCHITECTURAL PATH',
      painTitle: 'Traditional AI Pitfalls vs. Fabrica Operating System',
      pipelineTitle: 'The 7-Step Drafting Pipeline',
      pipelineTag: 'Every Build Is Audited Before It’s Approved',
      ...
      researchTitle: 'Official Docs Retrieved Every Session',
      researchSub: 'Deep Research Mode queries live authoritative documentation before a single line of code is committed.',
      alwaysOnTag: 'Always-On Operational Memory',
      alwaysOnTitle: 'Some Missions Don’t Need You to Ask Twice',
      alwaysOnSub: 'Standard tasks and recurring maintenance run in the background on your schedule.',
      lawsTag: 'Six Laws the Kernel Cannot Break',
      lawsTitle: 'Agent Kernel & Architecture',
      secTag: 'Enterprise Security & Isolation',
      secTitle: 'Built for Scale, Isolated by Tenant'
    }
  },
  FR: {
    nav: { matrix: 'La Matrice', systems: 'Systèmes', workspace: 'Espace de Travail', deepResearch: 'Recherche Approfondie', faqs: 'FAQs', openDashboard: 'Ouvrir le Tableau de Bord' },
    hero: {
      tag: 'Transformation Numérique pour Entreprises & Utilisateurs Avancés',
      h1: 'NOUS CONSTRUISONS DES SYSTÈMES SUR MESURE À PARTIR DE TOUTE DONNÉE.',
      sub: 'L’IA sait COMMENT construire. Fabrica lui montre QUOI.',
      desc: 'Votre modèle IA est le cerveau. Il est intelligent et interchangeable — passez de Gemini à Claude ou OpenRouter sans rien perdre. Fabrica est le corps : la base de données relationnelle, le sandbox d’exécution et l’historique des missions.',
      launchBtn: 'Lancer Votre Espace de Travail',
      seeBuildsBtn: 'Voir Ce Qu’il Construit Réellement'
    },
    sections: {
      personasTitle: 'CHOISISSEZ VOTRE PARCOURS D’ARCHITECTURE',
      painTitle: 'Pièges de l’IA Traditionnelle vs. Système d’Exploitation Fabrica',
      pipelineTitle: 'Le Pipeline de Rédaction en 7 Étapes',
      pipelineTag: 'Chaque Build Est Audité Avant Approbation',
      ...
      researchTitle: 'Documentation Officielle Récupérée à Chaque Session',
      researchSub: 'Le mode Recherche Approfondie interroge la documentation officielle en direct avant tout engagement de code.',
      alwaysOnTag: 'Mémoire Opérationnelle Continue',
      alwaysOnTitle: 'Certaines Missions N’ont Pas Besoin d’Être Demandées Deux Fois',
      alwaysOnSub: 'Les tâches standard et la maintenance récurrente s’exécutent en arrière-plan selon votre planning.',
      lawsTag: 'Six Lois Que le Noyau Ne Peut Pas Enfreindre',
      lawsTitle: 'Noyau d’Agent & Architecture',
      secTag: 'Sécurité Entreprise & Isolation',
      secTitle: 'Conçu pour l’Échelle, Isolé par Client'
    }
  },
  AR: {
    nav: { matrix: 'مصفوفة العمل', systems: 'الأنظمة', workspace: 'مساحة العمل', deepResearch: 'البحث العميق', faqs: 'الأسئلة الشائعة', openDashboard: 'فتح لوحة التحكم' },
    hero: {
      tag: 'التحول الرقمي للمؤسسات والمستخدمين المحترفين',
      h1: 'بناء نظم ومخرجات مخصصة من أي مصدر بيانات.',
      sub: 'الذكاء الاصطناعي يعرف كيف يبني. Fabrica توضح له ماذا يبني.',
      desc: 'نموذج الذكاء الاصطناعي هو العقل (قابل للتغيير بحرية بين Gemini أو Claude أو OpenRouter). Fabrica هي الجسد: قاعدة البيانات العلاقاتية، بيئة التنفيذ المعزولة، وتاريخ المهام الذي يحفظ كل شيء.',
      launchBtn: 'بدء استخدام مساحة العمل',
      seeBuildsBtn: 'استكشف ما يتم بناؤه بالفعل'
    },
    sections: {
      personasTitle: 'اختر مسار البنية التحتية الخاص بك',
      painTitle: 'عيوب الذكاء الاصطناعي التقليدي مقابل نظام تشغيل Fabrica',
      pipelineTitle: 'مسار التخطيط المكون من 7 خطوات',
      pipelineTag: 'كل حزمة يتم تدقيقها قبل الاعتماد',
      ...
      researchTitle: 'استرجاع التوثيق الرسمي في كل جلسة',
      researchSub: 'يقوم وضع البحث العميق باسترجاع التوثيق المباشر والتحقق منه قبل اعتماد أي كود برمجي.',
      alwaysOnTag: 'ذاكرة تشغيلية دائمة العمل',
      alwaysOnTitle: 'مهام تنفذ تلقائيًا دون الحاجة لإعادتها',
      alwaysOnSub: 'المهام القياسية والصيانة الدورية تعمل في الخلفية وفقًا لجدولك الزمني.',
      lawsTag: 'ستة قوانين لا يمكن للنواة خرقها',
      lawsTitle: 'نواة العميل والبنية التحتية',
      secTag: 'الأمان والعزل المؤسسي',
      secTitle: 'مصمم للتوسع ومضمون بالعزل التام'
    }
  }
};
    ...
    <div dir={uiLang === 'AR' ? 'rtl' : 'ltr'} style={{ background: '#FAF9F6', color: '#1C1C1E', fontFamily: '"Inter", system-ui, sans-serif', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <footer className="border-t border-slate-200 bg-white py-12 px-6 md:px-12 mt-auto" style={{ paddingLeft: '10px', paddingRight: '10px' }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-xs text-slate-400 font-medium">{cta.footer}</div>
        </div>
      </footer>
