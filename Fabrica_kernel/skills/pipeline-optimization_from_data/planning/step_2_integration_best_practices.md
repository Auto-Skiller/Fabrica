...
## What
Invokes Deep Research Mode to research data binding frameworks, React state models, and database schema mappings related to the audited data types.

## When
Runs automatically after Step 1.

## Why
Ensures that the dashboard upgrades are built using modern design standards and verified library routes.
...
|-------|------|----|------------|
| integration_spec_sheet | JSON | Agent: step_3_hybrid_plan_qa.md | Stored in `missions.workflow_history` |
...
## Handoffs
- **Receives from**: Agent: `step_1_combined_audit.md`
- **Delivers to**: Agent: `step_3_hybrid_plan_qa.md`
...
2. **Invoke Operations**: Run the target operations or mode matching the step 2 integration best practices spec.
