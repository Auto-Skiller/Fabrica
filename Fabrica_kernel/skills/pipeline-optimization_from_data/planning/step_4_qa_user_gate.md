...
## What
A user-facing gate step that halts pipeline execution until the user selects and confirms their integration plan.

## When
Runs when options are written to `missions.qa_state`.

## Why
Guarantees the agent does not alter user database schemas or modify active dashboard source codes without direct selection guidance.

## Inputs
| Field | Type | From | UI/UX Note |
|-------|------|------|------------|
| integration_options | JSON | Agent: step_3_hybrid_plan_qa.md | Rendered in QA panel |

## Outputs
| Field | Type | To | UI/UX Note |
|-------|------|----|------------|
| user_selections | JSON | Agent: step_5_unified_scope.md | **UI: User integration path choice confirmation** |
...
- **Delivers to**: Agent: `step_5_unified_scope.md`
