# Step 7: Hybrid Blueprint

## What
A step-owned prescriptive logic file that constructs the final Hybrid Blueprint and transitions the mission to Phase Planning.

## When
Runs automatically after Step 6.

## Why
Consolidates schema migrations and React code changes into a single Hybrid Blueprint, handing off to task generation.

## Inputs
| Field | Type | From | UI/UX Note |
|-------|------|------|------------|
| unified_migration_scope | JSON | Agent: step_5_unified_scope.md | â€” |
| verified_library_specs | JSON | Agent: step_6_library_syntaxes.md | â€” |

## Outputs
| Field | Type | To | UI/UX Note |
|-------|------|----|------------|
| hybrid_blueprint | JSON | Agent: phase-planning.md | Triggers planning proposal generation |
...
## Handoffs
- **Receives from**: Agent: `step_6_library_syntaxes.md`
...
2. **Invoke Operations**: Run the target operations or mode matching the step 7 hybrid blueprint spec.
