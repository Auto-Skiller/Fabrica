...
## What
Invokes Analytics Mode to compile the user selections and generate a detailed column-by-column, table-by-table mapping configuration.

## When
Runs automatically after Step 4 schema confirmation.

## Why
Provides the exact logical database script spec, foreign keys, and indexes before verifying performance and syntaxes.

## Inputs
| Field | Type | From | UI/UX Note |
|-------|------|------|------------|
| selected_schema | JSON | User | Retrieved from `missions.qa_state.user_selections` |

## Outputs
| Field | Type | To | UI/UX Note |
|-------|------|----|------------|
| schema_mapping_sheet | JSON | Agent: step_6_performance_indexing_research.md | Stored in `missions.workflow_history` |
...
- **Delivers to**: Agent: `step_6_performance_indexing_research.md`
...
2. **Invoke Operations**: Run the target operations or mode matching the step 5 schema mapping spec.
