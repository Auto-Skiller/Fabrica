# Step 3: Refactoring Plan QA

## What
Step-owned prescriptive logic that converts the descriptive health audit and research references into exactly 3 optimization approaches with explicit impact risk, writing to `missions.qa_state`.

## When
Runs automatically after Step 2.

## Why
Provides the user with transparent options showing potential code impact and performance improvements, avoiding black-box refactoring.

## Inputs
| Field | Type | From | UI/UX Note |
|-------|------|------|------------|
| code_health_report | JSON | Agent: step_1_code_audit.md | â€” |
| upgrade_reference_spec | JSON | Agent: step_2_upgrade_discovery.md | â€” |

## Outputs
| Field | Type | To | UI/UX Note |
|-------|------|----|------------|
| refactoring_options | JSON | User | Rendered as cards in the QA panel |
...
## Handoffs
- **Receives from**: Agent: `step_2_upgrade_discovery.md`
...
2. **Invoke Operations**: Run the target operations or mode matching the step 3 refactoring plan qa spec.
